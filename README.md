...
```bash
sudo apt install -y git && git clone https://github.com/icarorandoli/instalador-multi-maste install && sudo chmod -R 777 ./install && cd ./install && sudo ./install_primaria
```
